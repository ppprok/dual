...
public:
    ...
    IntervalLattice(PosetItem::IntervalBound min, PosetItem::IntervalBound max)
        :_universalMaximal(min, max)
    {        
    }       
...
private:
    ...
    void BuildMaximalIndependent( PosetItem current, PosetItems::const_iterator begin, PosetItems::const_iterator end, PosetItems& result) const;

    void BuildMinimalIndependent( PosetItem current, PosetItems::const_iterator begin, PosetItems::const_iterator end, PosetItems& result) const;
