...
namespace PosetDualization {namespace MIGRAS{
    ...
    struct LocalState
    {
        ...
        UTILITY_MOVE_DEFAULT_MEMBERS(
            LocalState, (supportMap)(itemsForCover)(dependentItems));
    ...
    */
    ...
    struct CallbackParams
    {
        ...
        CallbackParams(ICallback* callback = 0, int delay = 100)
            :Tick(0), Delay(delay), Callback(callback)
        {
        }
        ...
        :public IConfigurable
    {
        ...
        PosetItems _maximalIndepBuffer;         ///< Буффер для отбора максимальных независимых элементов, используемых для покрытия
