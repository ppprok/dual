...
// Âûגמה גסוץ סעמכבצמג
struct AllColumnsFileWriterCallback:
    public IDualizationCallback,
    public IntegersFileWriter
{
    virtual void Call(DualizationNode& node);
};

// Âûגמה ףןמנÿהמקוםםûץ סעמכבצמג
class OrderedColumnsFileWriterCallback:
    public IDualizationCallback,
    public IntegersFileWriter
{
...
class FirstColumnFileWriterCallback:
    public IDualizationCallback,
    public IntegersFileWriter
{
public:                
...
class LastColumnFileWriterCallback:
    public IDualizationCallback,
    public IntegersFileWriter
{
public:                
...
// Âûגמה גוסא ןמךנûעטÿ
class WeightFileWriterCallback:
    public IDualizationCallback,
    public IntegersFileWriter
{
public:                
...
class MinColumnFileWriterCallback:
    public IDualizationCallback,
    public IntegersFileWriter
{
public:                
...
class MaxColumnFileWriterCallback:
    public IDualizationCallback,
    public IntegersFileWriter
{
public:                
