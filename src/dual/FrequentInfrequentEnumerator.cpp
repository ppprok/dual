...
void PosetDualization::FrequentInfrequentEnumerator::Enumerate(FrequentInfrequentTask const& task) {
    ...
    sort(Results, [](FrequentInfrequentDivision const& d1, FrequentInfrequentDivision const& d2) {
...
void PosetDualization::FrequentInfrequentEnumerator::AddMaximalFrequent(FrequentInfrequentDivision& division,
                                                                        PosetItems& items) {
    auto& pp = _task->GetPosetsProduct();
...
void PosetDualization::FrequentInfrequentEnumerator::AddMinimalInfrequent(FrequentInfrequentDivision& division,
                                                                          PosetItems& items) {
    auto& pp = _task->GetPosetsProduct();
...
void PosetDualization::FrequentInfrequentEnumerator::DecreaseFrequency(int threshold,
                                                                       PosetItems& current,
    ...
    for (int j = 0; j != n; ++j) {
        ...
        remove_if(support, [&poset, &current, &column, j](int r) { return !poset.Preceq(current[j], column[r]); });
