...
int main(int argc, char* argv[]) {
    try {
        ...
        desc.add_options()("help",
                           "produce help message")("solver", po::value<std::string>(), "solver config file name")(
                "task",
                po::value<std::string>(),
                "task config file name")("input", po::value<std::string>(), "input file name")(
                "output",
                po::value<std::string>(),
                "output file name")("log", po::value<std::string>()->default_value("dualizer.log"), "log file name");
